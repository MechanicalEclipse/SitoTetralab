...
<div>
<!-- Features -->
  <div class="px-8 py-12 mx-auto md:px-12 lg:px-32 max-w-7xl text-center">
    <div class="mt-12 mb-24">
      <h1 class="text-4xl font-normal tracking-tighter text-gray-900 lg:text-5xl text-balance">
          Il metodo
        <span class="text-jaffa font-black">Tetralab</span>
        in poche parole
      </h1>
    ...
    <nav class="max-w-6xl mx-auto grid sm:flex gap-y-px sm:gap-y-0 sm:gap-x-4" aria-label="Tabs" role="tablist">
      ...
      <button type="button" class="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start transition ease-in-out duration-100 hover:bg-gray-100 p-3 md:p-5 rounded-xl" id="tabs-with-card-item-2" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
        <svg class="flex-shrink-0 hidden sm:block size-7 hs-tab-active:text-blue-600 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 14 4-4"/><path d="M3.34 19a10 10 0 1 1 17.32 0"/></svg>
        <span class="mt-5">
          <span class="hs-tab-active:text-blue-600 block font-semibold text-gray-800">Automation on a whole new level</span>
          <span class="hidden lg:block mt-2 text-gray-800">Use automation to scale campaigns profitably and save time doing it.</span>
        </span>
      </button>

      <button type="button" class="hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent w-full flex flex-col text-start transition ease-in-out duration-100 hover:bg-gray-100 p-3 md:p-5 rounded-xl" id="tabs-with-card-item-3" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
        <svg class="flex-shrink-0 hidden sm:block size-7 hs-tab-active:text-blue-600 text-gray-800" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
        <span class="mt-5">
          <span class="hs-tab-active:text-blue-600 block font-semibold text-gray-800">Solving problems for every team</span>
          <span class="hidden lg:block mt-2 text-gray-800">One tool for your company to share knowledge and ship projects.</span>
        </span>
      </button>
    ...
    <div class="mt-12 md:mt-16">
        ...
        <div class="max-w-[1140px] lg:pb-32 relative">
          ...
          <figure class="hidden absolute bottom-0 start-0 z-[2] max-w-full w-60 h-auto mb-20 ms-20 lg:block">
            <div class="p-1.5 bg-gray-100 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(45_55_75_/_20%),_0_2rem_4rem_-2rem_rgb(45_55_75_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(45_55_75_/_20%)]">
              <img class="max-w-full rounded-[1.25rem] h-auto" src="../assets/img/mockups/img9.jpg" alt="Image Description">
            </div>
          </figure>
          <!-- End Mobile Device -->

          <!-- Browser Device -->
          <figure class="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto shadow-[0_2.75rem_3.5rem_-2rem_rgb(45_55_75_/_20%),_0_0_5rem_-2rem_rgb(45_55_75_/_15%)] rounded-b-lg">
            <div class="relative flex items-center max-w-[50rem] bg-white border-b border-gray-100 rounded-t-lg py-2 px-24">
              ...
              <div class="flex justify-center items-center size-full bg-gray-200 text-[.25rem] text-gray-800 rounded-sm sm:text-[.5rem]">www.preline.co</div>
            </div>
        ...
        <div class="max-w-[1140px] lg:pb-32 relative">
          ...
          <figure class="hidden absolute bottom-0 start-0 z-[2] max-w-full w-60 h-auto mb-20 ms-20 lg:block">
            <div class="p-1.5 bg-gray-700 shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(0_0_0_/_20%),_0_2rem_4rem_-2rem_rgb(0_0_0_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(0_0_0_/_20%)] rounded-3xl">
              <img class="max-w-full rounded-[1.25rem] h-auto" src="../assets/img/mockups/img11.jpg" alt="Image Description">
            </div>
          </figure>
          <!-- End Mobile Device -->
      ...
      <div id="tabs-with-card-3" class="hidden" role="tabpanel" aria-labelledby="tabs-with-card-item-3">
        ...
        <div class="max-w-[1140px] lg:pb-32 relative">
          ...
          <figure class="hidden absolute bottom-0 start-0 z-[2] max-w-full w-60 h-auto mb-20 ms-20 lg:block">
            <div class="p-1.5 bg-gray-100 rounded-3xl shadow-[0_2.75rem_5.5rem_-3.5rem_rgb(45_55_75_/_20%),_0_2rem_4rem_-2rem_rgb(45_55_75_/_30%),_inset_0_-0.1875rem_0.3125rem_0_rgb(45_55_75_/_20%)]">
              <img class="max-w-full rounded-[1.25rem] h-auto" src="../assets/img/mockups/img13.jpg" alt="Image Description">
            </div>
          </figure>
          <!-- End Mobile Device -->
