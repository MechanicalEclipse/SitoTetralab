<div>
    <div class="mx-auto pt-10 max- mb-8 w-10/12 lg:mb-14 text-center">
        ...
        <p class="mt-3 text-gray-800">
            Tetralab è nata dalla volontà dei soci fondatori di creare un’impresa che potesse essere vincente nel supportare le attività industriali, artigianali e commerciali, private e pubbliche, e nel rispetto delle condizioni di salute e sicurezza dei luoghi di lavoro e dell’inquinamento dell’ambiente esterno, mediante servizi e tecnologie avanzate.
Con oltre 20 anni di solida esperienza maturata e grazie ai valori posseduti, Tetralab si distingue per essere diventata una realtà d’eccellenza, oltre che un riferimento affidabile riconosciuto da molte aziende. Offriamo infatti un servizio completo, accurato e attento alle esigenze delle imprese, consentendo una netta ed evidente riduzione degli impegni che devono affrontare per ottemperare ai vari adempimenti.
    ...
    <div class="grid grid-cols-1 content-center pb-16">
        <div class="place-self-center margin-auto space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                <!-- Icon -->
                <div class="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-jaffa text-slate-500 group-[.is-active]:text-emerald-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                ...
                <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                    <div class="flex items-center justify-start space-x-2 mb-1">
                        <time class="font-caveat font-medium text-curious-blue">1995</time>
                    </div>
                    <div class="text-slate-500">Andrea V. Cursoli inizia la sua avventura professionale nel settore della sicurezza sul lavoro e della consulenza ambientale</div>
                </div>
            </div>
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                    <div class="flex items-center justify-end space-x-2 mb-1">
                        <time class="font-caveat font-medium text-curious-blue">2001</time>
                    </div>
                    <div class="text-slate-500 text-right">Nasce Tetralab S.r.l., in una piccola sede a Sammichele di Bari</div>
                </div>
            </div>
